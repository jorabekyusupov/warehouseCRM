...
*/
    ...
    function R(n) {
        for (var t = n.f.length, e = 0; e < t; ++e) {
            ...
            if (-1 != o.indexOf("|")) u = !1; else {
                ...
                var s;
                s = u;
                var a = g(a, 2), f = "999999999999999".match(o)[0];
    ...
    function C(n, t) {
        ...
        if (!n.l) {
            if (!n.F) if (G(n)) {
                if (H(n)) return I(n)
            } else if (0 < n.h.length && (e = n.a.toString(), l(n.a), n.a.a(n.h), n.a.a(e), e = n.b.toString(), r = e.lastIndexOf(n.h), l(n.b), n.b.a(e.substring(0, r))), n.h != Z(n)) return n.b.a(" "), I(n);
            return n.i.toString()
        }
        switch (n.u.b.length) {
            case 0:
            ...
            case 3:
                ...
                n.A = !0;
            default:
                return n.A ? (H(n) && (n.A = !1), n.b.toString() + n.a.toString()) : 0 < n.f.length ? (e = P(n, t), r = D(n), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? V(n) : n.l ? U(n, e) : n.i.toString())) : M(n)
        }
    }
    ...
    function H(n) {
        ...
        return 0 != t && (l(n.a), n.a.a(r.toString()), r = E(t), "001" == r ? n.g = j(n.G, "" + t) : r != n.D && (n.g = B(n, r)), n.b.a("" + t).a(" "), n.h = "", !0)
    }
    ...
    var T = 1, Y = 2, k = 3, J = 4, K = 6, L = 16, O = 18;
...
*/
    var nn = {
        ...
        tn = {
            UZ: [
                null,
                [null, null, "[1-9]\\d{8}", null, null, null, null, null, null, [9], [7]],
                [null, null, "[1-9](?:\\d{7,9})?\\d{5}", null, null, null, "669050123", null, null, null, [7]],
                [null, null, "[1-9](?:\\d{7,10})?\\d{4}", null, null, null, "912345678"],
                ...
                null,
                [
                    [null, "(\\d{2})(\\d{3})(\\d{2})(\\d{2})", "$1 $2 $3 $4", ["[1-9]"], "8 $1"]
                ],
                null,
                [null, null, null, null, null, null, null, null, null, [-1]],
                null,
    ...
    var en = {
        ...
        "۸": "8",
        "۹": "9"
    }, ln = RegExp("[+＋]+"), rn = RegExp("([0-9０-９٠-٩۰-۹])"), un = /^\(?\$1\)?$/, an = new _;
    b(an, 11, "NA");
    var on = /\[([^\[\]])*\]/g, sn = /\d(?=[^,}][^,}])/g,
        fn = RegExp("^[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]*(\\$\\d[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]*)+$"),
        pn = /[- ]/;
    ...
    }, n("Cleave.AsYouTypeFormatter", $), n("Cleave.AsYouTypeFormatter.prototype.inputDigit", $.prototype.L), n("Cleave.AsYouTypeFormatter.prototype.clear", $.prototype.K)
